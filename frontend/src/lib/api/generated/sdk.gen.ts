 ...
 */
export const marketWatchlistGet = <ThrowOnError extends boolean = false>(options?: Options<MarketWatchlistGetData, ThrowOnError>) => (options?.client ?? client).get<MarketWatchlistGetResponses, MarketWatchlistGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Set Watchlist Endpoint
 *
 * Replaces the authenticated user's watchlist with the given symbols.
 */
export const marketWatchlistSet = <ThrowOnError extends boolean = false>(options: Options<MarketWatchlistSetData, ThrowOnError>) => (options.client ?? client).put<MarketWatchlistSetResponses, MarketWatchlistSetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/market/watchlist',
    ...options,
    headers: {
 ...
 */
export const marketWatchlistAddSymbol = <ThrowOnError extends boolean = false>(options: Options<MarketWatchlistAddSymbolData, ThrowOnError>) => (options.client ?? client).post<MarketWatchlistAddSymbolResponses, MarketWatchlistAddSymbolErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const marketWatchlistRemoveSymbol = <ThrowOnError extends boolean = false>(options: Options<MarketWatchlistRemoveSymbolData, ThrowOnError>) => (options.client ?? client).delete<MarketWatchlistRemoveSymbolResponses, MarketWatchlistRemoveSymbolErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
