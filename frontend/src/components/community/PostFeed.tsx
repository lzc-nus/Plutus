...
interface PostFeedProps {
  ...
  // changing this resets the feed (eg when switching tabs)
  feedKey: string;
...
export function PostFeed({
  ...
  // reset the feed when the user switches tabs or changes profile
  useEffect(() => {
  ...
  // load the first page once the feed have been reset
  useEffect(() => {
  ...
  // load another page when the user gets close to the bottom of the page
  useEffect(() => {
